use solana_feature_set::{
    enable_program_runtime_v2_and_loader_v4, zk_elgamal_proof_program_enabled, zk_token_sdk_enabled,
};
...
pub(crate) static BUILTINS: &[BuiltinPrototype] = &[
    ...
    BuiltinPrototype {
        feature_id: Some(enable_program_runtime_v2_and_loader_v4::id()),
